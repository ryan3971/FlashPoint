...
import android.os.Handler;
	...
	public class MovingBallsTarget2  {
	...
	public static double y;
	    ...
	    */
	   public MovingBallsTarget2(double left, double right, double top, double bottom) {
	   ...
	   public void draw(Canvas canvas) {
		   ...
		   ShapeDrawable shape = new ShapeDrawable(new OvalShape());
		    ...
		    if (shape.getBounds().contains((int)Drawing.flashX2, (int)Drawing.flashY2))	{
		    	
		    	Handler handler = new Handler();
				handler.postDelayed(runnables.runnable10, 0);
				
		    	Drawing.targetStop2 = true;
		    	Drawing.num2 = 0;
		    	MainActivity.draw.doScore((int)Drawing.flashX2, (int)Drawing.flashY2, (int)Drawing.touchX, (int)Drawing.touchY, Drawing.scoreRemember2);
		    }
//		    main.spotX = x;
	//		  main.spotY = y;
	...
	//	    	center = true;
	   ...
	   public void setLocation(double x, double y) {
	      MovingBallsTarget2.x = x;
	      MovingBallsTarget2.y = y;
	   }

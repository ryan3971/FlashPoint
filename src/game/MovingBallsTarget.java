...
import android.os.Handler;
	...
	public class MovingBallsTarget  {
	...
	public static double y;
	    ...
	    */
	   public MovingBallsTarget(double left, double right, double top, double bottom) {
	   ...
	   public void draw(Canvas canvas) {
		  ...
		  setRadius((int)width / 30);
		   ...
		   ShapeDrawable shape = new ShapeDrawable(new OvalShape());
		    ...
		    if (shape.getBounds().contains((int)Drawing.flashX, (int)Drawing.flashY))	{
		    	
		    	Handler handler = new Handler();
				handler.postDelayed(runnables.runnable10, 0);
		    	
		    	Drawing.targetStop = true;
		    	Drawing.num = 0;
		    	MainActivity.draw.doScore((int)Drawing.flashX, (int)Drawing.flashY, (int)Drawing.touchX, (int)Drawing.touchY, Drawing.scoreRemember);
...
//		    main.spotX = x;
	...
	//	    	center = true;
	   ...
	   public void setLocation(double x, double y) {
	      MovingBallsTarget.x = x;
	      MovingBallsTarget.y = y;
	   }
